...
public class ReportAssemblerTest {
	...
	public void testAssembleJSONReportBody() {
		...
		ReportGenerator generator = new ReportGenerator(new JSONReportAssembler());

		//assembler.setSaleEntry(createDummySaleEntry());
		Report report = generator.generate(createDummySaleEntry());
	...
	public void testAssembleXMLReportBody() {
		...
		ReportGenerator generator = new ReportGenerator(new XMLReportAssembler());
		Report report = generator.generate(createDummySaleEntry());
	...
	public void testAssembleHTMLReportBody() {
		...
		ReportGenerator generator = new ReportGenerator(new HTMLReportAssembler());
		Report report = generator.generate(createDummySaleEntry());
